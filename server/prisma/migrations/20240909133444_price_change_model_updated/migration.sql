/*
  ...
  - You are about to drop the column `range` on the `PriceChange` table. All the data in the column will be lost.
  - You are about to drop the column `type` on the `PriceChange` table. All the data in the column will be lost.
